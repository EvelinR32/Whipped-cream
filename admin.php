<head>
  ...
  <div id="spin-container">
    <?
     echo '<li class="nav-item"><a class="btn btn-outline-danger" aria-current="page" href="salir.php"><em>salir</em></a></li>';
 ?>
